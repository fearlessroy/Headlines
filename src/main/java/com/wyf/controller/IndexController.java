...
public class IndexController {
	...
	@ResponseBody
	public String profile(@PathVariable("groupId") String groupId, @PathVariable("userId") int userId, @RequestParam(value = "type", defaultValue = "1") int type,
	...
	@ResponseBody
	public String response(@CookieValue(value = "headline", defaultValue = "wyf") String headline, @RequestParam(value = "key", defaultValue = "key") String key,
