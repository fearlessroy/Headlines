...
public class HeadlineUtil {
	...
	public static final String HEADLINE_DOMAIN = "http://127.0.0.1:8080/";
	public static final String IMAGE_DIR = "F:/Projects/Engineering/headline/upload/";
	public static final String[] IMAGE_FILE_EXT = new String[]{"png", "bmp", "jpg", "jpeg"};
	public static final String QINIU_DOMAIN_PREFIX = "http://oauiukpl6.bkt.clouddn.com/";
	public static final int ANONYMOUS_ID = 2001;
